...
table.insert(particles, {system=ps, kickStartSteps=10, kickStartDt=0.53143892288208, emitAtStart=134, blendMode="add", shader=nil, texturePath="lightDot.png", texturePreset="lightDot", shaderPath="", shaderFilename=""})
